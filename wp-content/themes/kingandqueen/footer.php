<footer class="footer">
    <div class="footer__image"><img src="<?php echo get_template_directory_uri(); ?>/images/footer/conceptImage.webp" alt=""></div>
    <div class="footer__inner">
        <a class="footer__logo"><img src="<?php echo get_template_directory_uri() ?>/images/footer/footerLogo.svg" alt="ロゴ"></a>
        <ul class="footer__menues">
            <li>
                <a href="<?php echo home_url(); ?>/concept" class="footer__item">コンセプト</a>
                <img src="<?php echo get_template_directory_uri(); ?>/images/footer/arrow03.svg" alt="">
            </li>
            <li>
