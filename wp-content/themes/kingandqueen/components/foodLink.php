...
?>
    ...
    <?php while ($the_query->have_posts()) : $the_query->the_post(); ?>
        <a class="food__area__shops__item" href="<?php the_permalink(); ?>">
            <div>
                <img src="<?php echo get_template_directory_uri() . $imgPath; ?>" alt="<?php echo $name; ?>">
                <img src="<?php echo get_template_directory_uri() ?>/images/food/menu-corner.png" class="menu-corner">
            </div>
            <p><?php echo $name; ?></p>
        </a>
    <?php endwhile; ?>
<?php else : ?>
    <div class="food__area__shops__item" href="<?php the_permalink(); ?>">
        <?php if ($isComingSoon) : ?>
