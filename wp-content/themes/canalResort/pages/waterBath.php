    ...
    <div class="waterbath__content">
        ...
        <div class="waterbath__flexWrapper">
            ...
            <div class="waterbath__text waterbath__text--right">
                ...
                <p class="waterbath__desc waterbath__desc--left">湯温23℃の天然温泉をそのまま贅沢にかけ流し。お体への負担も少なく心地よくほてりをクールダウンします。</p>
            </div>
        </div>
        ...
        <div class="waterbath__flexWrapper">
            <div class="waterbath__text waterbath__text--left">
                ...
                <p class="waterbath__desc waterbath__desc--right">テキストが入りますテキストが入ります</p>
            </div>
